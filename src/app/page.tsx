...
function RecordRow({
  ...
  return (
    <div className="flex items-center justify-between gap-4 py-2.5">
      ...
      <span className="flex items-center gap-2 font-mono text-xs tnum text-foreground">
        {children}
      </span>
    </div>
  );
    ...
    <div className="space-y-20 sm:space-y-28">
      ...
      <section className="animate-rise max-w-3xl">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-2.5">
          ...
          <Link href="/sign-in" className="btn btn-ghost px-5 py-2.5">
            Sign in
          </Link>
        </div>

        <p className="mt-6 font-mono text-[11px] text-faint">
          Google sign-in · nothing to install · works on any phone
        </p>
      </section>
      ...
      <section>
        ...
        <div className="mt-10 grid border-t border-border sm:grid-cols-2 sm:gap-x-12">
        ...
        <ol className="mt-10 grid gap-8 sm:grid-cols-3 sm:gap-6">
          {STEPS.map((step, index) => (
            <li key={step.title} className="border-t border-foreground/15 pt-4">
              <p className="font-mono text-[11px] tnum text-faint">
                Step {index + 1}
              </p>
      ...
      <section className="border-t border-border pt-12 sm:pt-16">
        <div className="flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between">
          ...
          <SignUpButton mode="modal" fallbackRedirectUrl="/" forceRedirectUrl="/">
            <button className="btn btn-primary shrink-0 px-5 py-2.5">
